...
app.get('/get-script/:name', checkAuth, (req, res) => {
    ...
    if (name === "config.json") {
        ...
        filePath = findFileRecursive(path.join(rootDir, 'Commands'), name + '.js');
    }
...
app.post('/save-script', checkAuth, (req, res) => {
    ...
    if (fileName === "config.json") {
        ...
        filePath = findFileRecursive(path.join(rootDir, 'Commands'), fileName + '.js');
    }
...
app.get('/download-db', checkAuth, (req, res) => {
    const dbPath = "/home/container/database.sqlite3";
